...
public class SetNewPosition : MonoBehaviour
{
    ...
    private List<Quaternion> _modelRotation;
    ...
    public void SetStatus()
    {
        ...
        _modelRotation = EditManager.GetInstance().ModelEntireRot;
    }
    ...
    private void SetAnimation()
    {
        ...
        transform.rotation = _modelRotation[currentFrame];
        ...
        _humanPose.bodyPosition = _hipObject.transform.localPosition + Vector3.up;
